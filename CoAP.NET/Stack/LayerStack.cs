...
namespace CoAP.Stack
{
    ...
    {
        private static readonly ILogger _logger = LogManager.GetLogger<LayerStack>();
        ...
        public void SendRequest(Request request) {
            try {
                ...
                _logger.LogError("LayerStack.SendRequest - Exception during processing ", ex);
            }
        }
        ...
        public void SendResponse(Exchange exchange, Response response) {
            try {
                ...
                _logger.LogError("LayerStack.SendResponse - Exception during processing ", ex);
                throw;
            }
        }
        ...
        private class StackBottomLayer : AbstractLayer
        {
            public override void SendRequest(INextLayer nextLayer, Exchange exchange, Request request) {
        ...
        private class NextLayer : INextLayer
        {
