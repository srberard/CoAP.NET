...
namespace CoAP.EndPoint.Resources
{
    ...
    {
        private static readonly ILogger _logger = LogManager.GetLogger<RemoteResource>();
        ...
        public void AddSubResource(RemoteResource resource) {
            ...
            if (_logger.IsEnabled(LogLevel.Debug)) _logger.LogDebug("Add resource " + resource.Name);
        }
        ...
        /// <inheritdoc/>
        public IResource Match(IEnumerator<String> paths) {
