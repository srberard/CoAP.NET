...
namespace CoAP.Server
{
    ...
    {
        private static readonly ILogger _logger = LogManager.GetLogger<CoapServer>();
        ...
        // SRB:  Commented out as it is not strictly needed
        ///// <summary>
        ...
        /// <inheritdoc/>
        public void Start() {
            _logger.LogDebug("Starting CoAP server");
            ...
            foreach (IEndPoint endpoint in _endpoints) {
                try {
                    ...
                    if (_logger.IsEnabled(LogLevel.Warning)) _logger.LogWarning("Could not start endpoint " + endpoint.LocalEndPoint, e);
                }
            }
        ...
        /// <inheritdoc/>
        public void Stop() {
            _logger.LogDebug("Stopping CoAP server");
