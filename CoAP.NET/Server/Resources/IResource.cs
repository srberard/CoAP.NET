...
namespace CoAP.Server.Resources
{
    ...
    public interface IResource
    {
        ...
        /// <summary>
        /// Attempts to match one or more UriPaths to a child.</summary>
        /// <summary>
        /// <parm name="paths"></parm>
        /// <returns>An IResource if the path(s) matches</returns>
        IResource Match(IEnumerator<String> paths);
