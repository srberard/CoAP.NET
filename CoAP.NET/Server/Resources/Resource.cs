...
namespace CoAP.Server.Resources
{
    ...
    {
        private static readonly ILogger _logger = LogManager.GetLogger<Resource>();
        private static readonly IEnumerable<IEndPoint> _EmptyEndPoints = new IEndPoint[0];
        ...
        /// <inheritdoc/>
        public virtual IResource Match(IEnumerator<String> paths) {
            return this.GetChild(paths.Current);
        }
